...
# see: man 5 terminfo - <https://man.archlinux.org/man/terminfo.5>.
...
# Use Ctrl+Left/Right to move to the beginning of the previous/next word.
...
# Move cursor to the beginning/end of the line (emacs-like).
